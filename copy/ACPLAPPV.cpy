      *****************************************************************
      **  MEMBER : ACPLAPPV                                          **
      **  REMARKS: CALL TO ASRUAPPV - APPV PROCESSING PROGRAM        **
      **                                                             **
      *****************************************************************
...
557660     MOVE WPGWS-PREV-PGM-ID       TO WGLOB-PREV-PGM-ID.
       ...
       APPV-1000-PROCESS-APPV-FIELD-X.
           EXIT.
 
      *****************************************************************
      **                 END OF COPYBOOK ACPLAPPV                    **
      *****************************************************************
